...
<head>
    ...
    <!-- Animate.css -->
    <link href="{{ asset('asset/admin/vendors/animate.css/animate.min.css') }}" rel="stylesheet">
                ...
                <section class="login_content">
                    <form action="{{ route('admin.login.post') }}" method="POST">
                        ...
                        <div class="separator">
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-paw"></i> GreenZ!</h1>
                                <p>©2026 All Rights Reserved. NGUYEN LE ANH KIET! is a Bootstrap 4 template. Privacy and
                                    Terms</p>
