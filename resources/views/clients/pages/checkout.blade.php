                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="input-item">
                                            <input type="text" name="ltn_address" placeholder="Số nhà và tên đường"
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <h6>State </h6>
                                        <div class="input-item">
                                            <input type="text" name="ltn_city" placeholder="Thành phố"
                                ...
                                <div class="card">
                                    <h5 class="ltn__card-title">
                                        ...
                                        <label for="payment_cod">
                                            ...
                                            <img src="{{ asset('asset/clients/img/icons/cash.png') }}">
                                        </label>
                                    </h5>
                                </div>
                                ...
                                <div class="card">
                                    <h5 class="collapsed ltn__card-title">
                                        ...
                                        <label for="payment_paypal">
                                            PayPal <img src="{{ asset('asset/clients/img/icons/payment-3.png') }}">
                                        </label>
                                    </h5>
                                </div>
                            </div>
                            <div class="ltn__payment-note mt-30 mb-30">
                                <p>Dữ liệu cá nhân của bạn sẽ được sử dụng để xử lý đơn hàng của bạn, hỗ trợ trải nghiệm
                                    của
                                    bạn
                                    trên toàn bộ trang web này và cho các mục đích khác được mô tả trong chính sách bảo
                                    mật
                                    của
                                    chúng tôi.</p>
                            </div>
                            <button class="btn theme-btn-1 btn-effect-1 text-uppercase" type="submit"
                                id="order_button_cash">Đặt
                                hàng
                            </button>
