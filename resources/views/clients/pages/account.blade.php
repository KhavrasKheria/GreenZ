                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" id="liton_tab_dashboard">
                                            <div class="ltn__myaccount-tab-content-inner">
                                                <p>Xin chào <strong>{{ $user->email }}</strong> (not
                                                    <strong>{{ $user->email }}</strong>?
                                                    <small><a href="javascript:void(0)">Đăng xuất</a></small>)

                                                </p>
                                                <p>Từ bảng điều khiển tài khoản của bạn, bạn có thể xem các <span>đơn hàng
                                                        gần đây</span>, quản lý <span>địa chỉ giao hàng và thanh toán
                                                        của mình</span>, và <span>chỉnh sửa mật khẩu cũng như thông tin
                                                        tài khoản</span>.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="liton_tab_address">
                                            <div class="ltn__myaccount-tab-content-inner">
                                                <p>Các địa chỉ sau đây sẽ được sử dụng mặc định tại trang thanh toán.</p>
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                ...
                                                <div class="modal-content" style="padding: 10px 10px">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('account.addresses.add') }}" method="POST"
                                                            id="addAdressForm">
                                                            <div class="mb-3">
                                                                <label for="user_name" class="form-label">Tên người
                                                                    dùng</label>
                                                            ...
                                                            <div class="form-check mb-3">
                                                                ...
                                                                <label class="form-label" for="default">Đặt làm địa chỉ
                                                                    mặc định</label>
                                                            </div>
                                                            <button type="submit"
                                            ...
                                            <div class="ltn__myaccount-tab-content-inner">
                                                ...
                                                <div class="ltn__form-box">
                                                    <form action="{{ route('account.update') }}" method="POST"
                                                        ...
                                                        @method('PUT')
                                                        <div class="row mb-50">
                                                            <div class="col-md-12 text-center mb-3 profile-pic-container">
                                                                <img src="{{ asset('storage/' . $user->avatar) }}"
                                                                    alt="Avatar" alt="Avatar" id="preview-image"
                                                                    class="profile-pic">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" name="ltn_phone_number"
                                                                    id="ltn_phone_number"
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" name="ltn_email" id="ltn_email"
                                            ...
                                            <div class="ltn__myaccount-tab-content-inner">
                                                ...
                                                <div class="ltn__form-box">
                                                    <form action="{{ route('account.change-password') }}" method="POST"
                                                        ...
                                                        <div class="btn-wrapper">
                                                            <button class="btn theme-btn-1 btn-effect-1 text-uppercase">Đổi
                                                                mật khẩu</button>
                                                        </div>
                                                    </form>
