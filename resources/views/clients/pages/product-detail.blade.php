...
"
                                    ...
                                    <div class="ltn__safe-checkout">
                                        ...
                                        <img src="{{ asset('asset/clients/img/icons/payment-2.png') }}"
                                            alt="Payment Image">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ltn__shop-details-tab-menu">
                            <div class="nav">
                                <a class="active show" data-bs-toggle="tab"
                                    href="#liton_tab_details_description">Description</a>
                                <a data-bs-toggle="tab" href="#liton_tab_details_reviews" class="">Reviews</a>
                            </div>
                        </div>
