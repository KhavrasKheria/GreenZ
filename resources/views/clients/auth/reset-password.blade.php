...
@section('content')
    <div class="container pb-76">
        <h2>Đặt lại mật khẩu</h2>
        <div class="lm_myaccount-tab-content-inner">
            <div class="lm_form-box">
                <form action="{{ route('password.update') }}" method="POST" id="reset-password-form">
                    ...
                    <div class="btn-wrapper">
                        <button type="submit" class="theme-btn-1 btn black-btn text-uppercase">Đặt lại mật khẩu
                            khẩu</button>
                    </div>
                </form>
            </div>
