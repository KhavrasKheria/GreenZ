            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="ltn__top-bar-menu">
                        <ul>
                            <li><a href="locations.html"><i class="icon-placeholder"></i>A35/36E ấp 3B, Bình Hưng, Bình
                                    Chánh, đường Nguyễn Văn Linh</a></li>
                            <li><a href="mailto:minhdien.dev@gmail.com?Subject=Contact%20with%20to%20you"><i
                                        class="icon-mail"></i> kieta123123@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-5">
            ...
            <div class="row">
                <div class="col">
                    <div class="site-logo-wrap">
                        <div class="site-logo">
                            <a href="{{ route('home') }}    "><img src="{{ asset('asset/clients/img/logo.png') }}"
                                    alt="Logo"></a>
                        </div>
                    </div>
                </div>
                        ...
                        <nav>
                            <div class="ltn__main-menu">
                                <ul>
                                    ...
                                    <li class="special-link"><a href="contact.html">HỢP TÁC CUNG ỨNG</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                        ...
                        <a href="#ltn__utilize-cart-menu" class="ltn__utilize-toggle">
                            ...
                            <sup id="cart_count">
                                @auth
                                    ...
                                    {{-- ✅ đếm số dòng --}}
                                @else
                                    {{ session('cart') ? count(session('cart')) : 0 }} {{-- ✅ đếm số key --}}
                                @endauth
                            </sup>
                        </a>
                    </div>
