            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="ltn__top-bar-menu">
                        <ul>
                            <li><a href="locations.html"><i class="icon-placeholder"></i> A35/36E ấp, Bình Hưng, Bình
            ...
            <div class="row">
                <div class="col">
                    <div class="site-logo-wrap">
                        <div class="site-logo">
                            <a href="{{ route('home') }}"><img src="{{ asset('asset/clients/img/logo-2.png') }}"
                                    alt="Logo"></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="ltn__main-menu">
                                <ul>
                                    ...
                                    <li class="special-link">
                                        <a href="contact.html">HỢP TÁC CUNG ỨNG</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
