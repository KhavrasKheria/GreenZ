             ...
             <div class="row">
                 <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                     <div class="footer-widget footer-about-widget">
                         <div class="footer-logo">
                             <div class="site-logo">
                                 <img src="{{asset('asset/clients/img/logo-2.png')}}" alt="Logo">
                             </div>
                         </div>
                         <p>Nền tảng thương mại điện tử tiên phong trong việc kết nối, phân phối thực phẩm sạch
                                    và nông sản hữu cơ đạt chuẩn đến mọi nhà.</p>
                             ...
                             <ul>
                                 <li>
                                     ...
                                     <div class="footer-address-info">
                                          <p>A35/36E ấp 3B, Bình Hưng, Bình Chánh, đường Nguyễn Văn Linh</p>
                                     </div>
                                 </li>
                                 <li>
                                     <div class="footer-address-icon">
                                     ...
                                     <div class="footer-address-info">
                                         <p><a href="tel:+0123-456789">0776611753</a></p>
                                     </div>
                                 </li>
                                 <li>
                                     <div class="footer-address-icon">
                                     ...
                                     <div class="footer-address-info">
                                         <p><a href="mailto:minhdien.dev@gmail.com">kieta123123@gmail.com</a>
                                         </p>
                                     </div>
                                 </li>
                             </ul>
                 ...
                 <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                     <div class="footer-widget footer-newsletter-widget">
                         ...
                         <img src="{{asset('asset/clients/img/icons/payment-4.png')}}" alt="Payment Image">
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="row">
                 <div class="col-md-6 col-12">
                     <div class="ltn__copyright-design clearfix">
                         <p>Toàn bộ bản quyền được bảo lưu @ Công ty <span class="current-year"></span></p>
                     </div>
                 </div>
