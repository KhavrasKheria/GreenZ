...
class AccountController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'ltn_phone_number' => 'nullable|string|max:255',
        ...
        $user->name = $request->ltn_name;
        $user->phone_number = $request->ltn_phone_number;
        $user->address = $request->ltn_address;
        $user->save();
    ...
    public function updatePrimaryAddress($id)
    {
        ...
        //Set all addresses of this user default = 0
        ShippingAddress::where('user_id', Auth::id())
            ->update(['default' => 0]);

        //Update selected address => default = 1
